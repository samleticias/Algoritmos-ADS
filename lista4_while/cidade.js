...
function main(){
    ...
    let quantidade_anos_necessarios = 0
    ...
    while(populacao_futura_cidade_a  <= populacao_cidade_b){
        ...
        quantidade_anos_necessarios++
    }

    print(`Quantidade de anos necessários para cidade A ultrapassar cidade B: ${quantidade_anos_necessarios}`)

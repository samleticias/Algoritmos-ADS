...
import {resetar_vetor, obter_posicao_maior_valor, obter_posicao_menor_valor, obter_maior_valor, obter_menor_valor, gerar_novo_vetor, 
    preencher_vetor_automaticamente, preencher_vetor, obter_somatorio_valores, obter_media_valores, preencher_vetor_min_max, atualizar_valor,
    mostra_valores_positivos, mostra_valores_negativos, multiplicar_valores, exponencia_elementos, remove_valor_por_posicao, remove_valor,
...
function main(){
    ...
    while (opcao !== 0){
        ...
        // 1 - Inicializar Vetor Numérico
            ...
            clear_screen()
            let op_inicializacao = -1

            while (op_inicializacao !== 0) {
                clear_screen()
                op_inicializacao = exibir_opcoes(menu_inicializacao_vetor())  

                // 0 - Sair
                if (op_inicializacao == 0) {
                    clear_screen()
                    exibe_texto('Saindo...')
                    break
                
                // 1 - Gerar vetor de tamanho N
                } else if (op_inicializacao == 1){
                    clear_screen()
